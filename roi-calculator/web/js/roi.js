...
growTree: function() {   
    var fallingInitTop = 70;
    var fallingInitLeft = 200;
    var fallingDestTop1 = 245;
    ...
    $('.apple').css({ "width":"0" }); 
    $('#apple2').css({"top":"70px", "left":"200px"  });
    $('#apple2').rotate(0);
    roi.timeouts[0] = setTimeout(function(){$('#appletree').animate({  "width": "+=90px" },{duration:3000, easing:'easeInElastic'  });}, 0);                       
...
showErrorTooltip: function($field, message) {
    ...
    $field.after('<div ' + ($field.hasClass('suggestedAppClass') || $field.hasClass('basicAppClass') ? 'style="left:301px;"' : '') + ' class="my-tooltip fade right in" id="'+ $field.attr("id") +'_tooltip"><div class="my-tooltip-arrow"></div><div class="my-tooltip-inner">'+message+'</div></div>');                          
},
